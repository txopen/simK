...
<!-- badges: start -->
`r badger::badge_devel("txopen/simK", "blue")`
...
[![Codecov test coverage](https://codecov.io/gh/txopen/simK/branch/main/graph/badge.svg)](https://app.codecov.io/gh/txopen/simK?branch=main)
<!-- badges: end -->

:dart: Functions to procedurally generate synthetic data in R for kidney transplant simulations. You can see `simK` in action, [here](https://txopen.github.io/simK/index.html).
...
Synthetic data can be used for preliminary analysis and the development of analysis code.
...
A detailed description of these functions usage, is available from [here](https://txopen.github.io/simK/articles/simk.html).
